...
==================
*/
int32 BotGetItemTeamGoal(char* goalname, bot_goal_t* goal)
{
    int32 i;
...
==================
*/
int32 BotGetMessageTeamGoal(bot_state_t* bs, char* goalname, bot_goal_t* goal)
{
    bot_waypoint_t* cp;
...
==================
*/
int32 FindClientByName(char* name)
{
    int32        i;
...
==================
*/
int32 FindEnemyByName(bot_state_t* bs, char* name)
{
    int32        i;
    char         buf[MAX_INFO_STRING];
    static int32 maxclients;
...
==================
*/
int32 NumPlayersOnSameTeam(bot_state_t* bs)
{
    int32        i, num;
    char         buf[MAX_INFO_STRING];
    static int32 maxclients;
...
==================
*/
int32 BotGetPatrolWaypoints(bot_state_t* bs, bot_match_t* match)
{
...
==================
*/
int32 BotAddressedToBot(bot_state_t* bs, bot_match_t* match)
{
...
==================
*/
static float BotNearestVisibleItem(bot_state_t* bs, const char* itemname, bot_goal_t* goal)
{
    int32       i;
    char        name[64];
    bot_goal_t  tmpgoal;
...
{
    float              dist, bestdist;
    int32              i, bestitem, redtt, bluett, client;
    bot_goal_t         goal;
    char               netname[MAX_MESSAGE_SIZE];
    static const char* nearbyitems[] = {
        "Shotgun",
        "Grenade Launcher",
        "Rocket Launcher",
        "Plasmagun",
...
==================
*/
int32 BotMatchMessage(bot_state_t* bs, char* message)
{
    bot_match_t match;
