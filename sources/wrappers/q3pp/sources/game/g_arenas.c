...
static tavros::core::logger logger("g_arenas");
...
void UpdateTournamentInfo()
{
    ...
    int32      n, accuracy, perfect, msglen;
    int32      buflen;
...
static gentity_t* SpawnModelOnVictoryPad(gentity_t* pad, vec3_t offset, gentity_t* ent, int32 place)
{
    gentity_t* body;
    vec3_t     vec;
    vec3_t     f, r, u;
