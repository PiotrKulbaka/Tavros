...
static tavros::core::logger logger("bg_pmove");
...
===================
*/
static void PM_StartTorsoAnim(int32 anim)
{
...
static void PM_StartLegsAnim(int32 anim)
{
    if (pm->ps->pm_type >= PM_DEAD) {
        return;
    }
...
static void PM_ContinueLegsAnim(int32 anim)
{
...
static void PM_ContinueTorsoAnim(int32 anim)
{
...
static void PM_ForceLegsAnim(int32 anim)
{
    pm->ps->legsTimer = 0;
    PM_StartLegsAnim(anim);
}
...
================
*/
static int32 PM_FootstepForSurface()
{
...
=============
*/
static int32 PM_CorrectAllSolid(trace_t* trace)
{
    int32  i, j, k;
    vec3_t point;
...
static void PM_Footsteps()
{
    ...
    old = pm->ps->bobCycle;
    pm->ps->bobCycle = (int32) (old + bobmove * pml.msec) & 255;
...
===============
*/
static void PM_BeginWeaponChange(int32 weapon)
{
...
void PmoveSingle(pmove_t* pmove)
{
    ...
    // this counter lets us debug movement problems by setting a conditional breakpoint fot the previous frame
    c_pmove++;
