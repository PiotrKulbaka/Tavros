...
==================
*/
int32 BotGetAirGoal(bot_state_t* bs, bot_goal_t* goal)
{
...
==================
*/
int32 BotGoForAir(bot_state_t* bs, int32 tfl, bot_goal_t* ltg, float range)
{
    bot_goal_t goal;
...
==================
*/
int32 BotNearbyGoal(bot_state_t* bs, int32 tfl, bot_goal_t* ltg, float range)
{
    int32 ret;
...
==================
*/
int32 BotReachedGoal(bot_state_t* bs, bot_goal_t* goal)
{
...
==================
*/
int32 BotGetItemLongTermGoal(bot_state_t* bs, int32 tfl, bot_goal_t* goal)
{
...
==================
*/
int32 BotGetLongTermGoal(bot_state_t* bs, int32 tfl, int32 retreat, bot_goal_t* goal)
{
...
==================
*/
int32 BotLongTermGoal(bot_state_t* bs, int32 tfl, int32 retreat, bot_goal_t* goal)
{
...
==================
*/
int32 AINode_Intermission(bot_state_t* bs)
{
...
==================
*/
int32 AINode_Observer(bot_state_t* bs)
{
...
==================
*/
int32 AINode_Stand(bot_state_t* bs)
{
...
==================
*/
int32 AINode_Respawn(bot_state_t* bs)
{
...
==================
*/
int32 BotSelectActivateWeapon(bot_state_t* bs)
{
...
==================
*/
int32 AINode_Seek_ActivateEntity(bot_state_t* bs)
{
    bot_goal_t*      goal;
...
==================
*/
int32 AINode_Seek_NBG(bot_state_t* bs)
{
    bot_goal_t       goal;
    vec3_t           target, dir;
    bot_moveresult_t moveresult;
...
==================
*/
int32 AINode_Seek_LTG(bot_state_t* bs)
{
    bot_goal_t       goal;
    vec3_t           target, dir;
    bot_moveresult_t moveresult;
...
==================
*/
int32 AINode_Battle_Fight(bot_state_t* bs)
{
    int32            areanum;
    vec3_t           target;
    aas_entityinfo_t entinfo;
...
==================
*/
int32 AINode_Battle_Chase(bot_state_t* bs)
{
    bot_goal_t       goal;
    vec3_t           target, dir;
    bot_moveresult_t moveresult;
...
==================
*/
int32 AINode_Battle_Retreat(bot_state_t* bs)
{
    bot_goal_t       goal;
    aas_entityinfo_t entinfo;
    bot_moveresult_t moveresult;
...
==================
*/
int32 AINode_Battle_NBG(bot_state_t* bs)
{
    int32            areanum;
    bot_goal_t       goal;
    aas_entityinfo_t entinfo;
