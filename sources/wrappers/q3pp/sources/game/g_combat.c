...
static tavros::core::logger logger("g_combat");
...
============
*/
void ScorePlum(gentity_t* ent, vec3_t origin, int32 score)
{
    gentity_t* plum;
...
==================
*/
void GibEntity(gentity_t* self, int32 killer)
{
    gentity_t* ent;
    int32      i;
...
==================
*/
void player_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int32 damage, int32 meansOfDeath)
{
    gentity_t*  ent;
    int32       anim;
    int32       contents;
    ...
    if (attacker && attacker->client) {
        ...
        if (attacker == self || OnSameTeam(self, attacker)) {
            ...
            // check for two kills in a int16 amount of time
...
================
*/
int32 CheckArmor(gentity_t* ent, int32 damage, int32 dflags)
{
    gclient_t* client;
    int32      save;
    int32      count;
...
bool G_RadiusDamage(vec3_t origin, gentity_t* attacker, float damage, float radius, gentity_t* ignore, int32 mod)
{
    ...
    for (e = 0; e < numListedEntities; e++) {
        ...
        if (CanDamage(ent, origin)) {
            ...
            dir[2] += 24;
            G_Damage(ent, NULL, attacker, dir, origin, (int32) points, DAMAGE_RADIUS, mod);
        }
    }
