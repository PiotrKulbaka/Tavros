...
void Bullet_Fire(gentity_t* ent, float spread, int32 damage)
{
    trace_t    tr;
    vec3_t     end;
    float      r;
...
void ShotgunPattern(vec3_t origin, vec3_t origin2, int32 seed, gentity_t* ent)
{
    int32  i;
    float  r, u;
    vec3_t end;
