...
==================
*/
void ClientTimerActions(gentity_t* ent, int32 msec)
{
    gclient_t* client;
...
================
*/
void ClientEvents(gentity_t* ent, int32 oldEventSequence)
{
    int32      i, j;
    int32      event;
    gclient_t* client;
