...
static tavros::core::logger logger("g_items");
...
int32 Pickup_Powerup(gentity_t* ent, gentity_t* other)
{
    int32      quantity;
    int32      i;
    gclient_t* client;
...
int32 Pickup_Holdable(gentity_t* ent, gentity_t* other)
{
...
int32 Pickup_Ammo(gentity_t* ent, gentity_t* other)
{
    int32 quantity;
...
int32 Pickup_Weapon(gentity_t* ent, gentity_t* other)
{
    int32 quantity;
...
int32 Pickup_Health(gentity_t* ent, gentity_t* other)
{
    int32 max;
    int32 quantity;
...
int32 Pickup_Armor(gentity_t* ent, gentity_t* other)
{
...
void G_CheckTeamItems()
{
    ...
    if (g_gametype->integer == GT_CTF) {
        ...
        if (!item || !itemRegistered[item - bg_itemlist]) {
            logger.warning("No team_CTF_redflag in map");
        }
        item = BG_FindItem("Blue Flag");
        if (!item || !itemRegistered[item - bg_itemlist]) {
            logger.warning("No team_CTF_blueflag in map");
        }
    }
}
...
============
*/
int32 G_ItemDisabled(gitem_t* item)
{
    char name[128];
