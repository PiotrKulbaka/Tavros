...
static tavros::core::logger logger("ai_main");
...
//
int32 bot_interbreed;
int32 bot_interbreedmatchcount;
//
...
==============
*/
void BotInputToUserCommand(bot_input_t* bi, usercmd_t* ucmd, int32 delta_angles[3], int32 time)
{
...
==============
*/
void BotUpdateInput(bot_state_t* bs, int32 time, int32 elapsed_time)
{
    bot_input_t bi;
    int32       j;
...
==============
*/
int32 BotAI(int32 client, float thinktime)
{
    bot_state_t* bs;
    char         buf[1024], *args;
    int32        j;
...
{
    int32          client, entitynum, inuse;
    int32          movestate, goalstate, chatstate, weaponstate;
...
int32 BotAIStartFrame(int32 time)
{
    ...
    int32             elapsed_time, thinktime;
    static int32      local_time;
    static int32      botlib_residual;
    static int32      lastbotthink_time;
