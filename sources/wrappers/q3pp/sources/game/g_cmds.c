...
static tavros::core::logger logger("g_cmds");
...
void DeathmatchScoreboardMessage(gentity_t* ent)
{
    ...
    int32      i, j;
    gclient_t* cl;
    int32      numSorted, scoreFlags, accuracy, perfect;
...
==================
*/
int32 ClientNumberFromString(gentity_t* to, char* s)
{
    gclient_t* cl;
    int32      idnum;
...
void Cmd_TeamTask_f(gentity_t* ent)
{
    ...
    int32 task;
    int32 client = ent->client - level.clients;
...
static void G_SayTo(gentity_t* ent, gentity_t* other, int32 mode, int32 color, const char* name, const char* message)
{
    if (!other) {
        return;
    }
...
void G_Say(gentity_t* ent, gentity_t* target, int32 mode, const char* chatText)
{
    int32      j;
    gentity_t* other;
    int32      color;
...
==================
*/
static void Cmd_Say_f(gentity_t* ent, int32 mode, bool arg0)
{
    char* p;
...
static void G_VoiceTo(gentity_t* ent, gentity_t* other, int32 mode, const char* id, bool voiceonly)
{
    int32       color;
    const char* cmd;
...
void G_Voice(gentity_t* ent, gentity_t* target, int32 mode, const char* id, bool voiceonly)
{
    int32      j;
    gentity_t* other;
...
==================
*/
static void Cmd_Voice_f(gentity_t* ent, int32 mode, bool arg0, bool voiceonly)
{
    char* p;
