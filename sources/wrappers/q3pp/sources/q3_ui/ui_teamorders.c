...
===============
*/
static void UI_TeamOrdersMenu_BackEvent(void* ptr, int32 event)
{
...
===============
*/
static void UI_TeamOrdersMenu_SetList(int32 id)
{
    switch (id) {
    default:
    case ID_LIST_BOTS:
...
=================
*/
sfxHandle_t UI_TeamOrdersMenu_Key(int32 key)
{
    menulist_s* l;
    int32       x;
    int32       y;
...
===============
*/
static void UI_TeamOrdersMenu_ListEvent(void* ptr, int32 event)
{
    int32 id;
    int32 selection;
    char  message[256];
...
void UI_TeamOrdersMenu_f()
{
    ...
    __UI_GetClientState(&cs);
    __UI_GetConfigString(CS_PLAYERS + cs.clientNum, info, MAX_INFO_STRING);
