...
=================
*/
static void ServerInfo_Event(void* ptr, int32 event)
{
...
=================
*/
static sfxHandle_t ServerInfo_MenuKey(int32 key)
{
...
void UI_ServerInfoMenu()
{
    ...
    __UI_GetConfigString(CS_SERVERINFO, s_serverinfo.info, MAX_INFO_STRING);
