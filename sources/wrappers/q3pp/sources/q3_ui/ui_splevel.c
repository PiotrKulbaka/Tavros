...
static int32 selectedArenaSet;
static int32 selectedArena;
static int32 currentSet;
static int32 currentGame;
static int32 trainingTier;
static int32 finalTier;
static int32 minTier;
...
=================
*/
static void PlayerIcon(const char* modelAndSkin, char* iconName, int32 iconNameMaxSize)
{
    char* skin;
...
=================
*/
static void UI_SPLevelMenu_SetMenuArena(int32 n, int32 level, const char* arenaInfo)
{
    char map[MAX_QPATH];
...
static void UI_SPLevelMenu_ResetEvent(void* ptr, int32 event)
{
...
=================
*/
static void UI_SPLevelMenu_LevelEvent(void* ptr, int32 notification)
{
...
=================
*/
static void UI_SPLevelMenu_LeftArrowEvent(void* ptr, int32 notification)
{
    if (notification != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_SPLevelMenu_RightArrowEvent(void* ptr, int32 notification)
{
    if (notification != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_SPLevelMenu_PlayerEvent(void* ptr, int32 notification)
{
    if (notification != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_SPLevelMenu_AwardEvent(void* ptr, int32 notification)
{
    int32 n;
...
=================
*/
static void UI_SPLevelMenu_NextEvent(void* ptr, int32 notification)
{
    if (notification != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_SPLevelMenu_BackEvent(void* ptr, int32 notification)
{
    if (notification != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_SPLevelMenu_CustomEvent(void* ptr, int32 notification)
{
    if (notification != QM_ACTIVATED) {
        return;
    }
...
void UI_SPLevelMenu_Cache()
{
    ...
    for (n = 0; n < 6; n++) {
        ...
        levelMenuInfo.awardSounds[n] = S_RegisterSound(ui_medalSounds[n], false);
    }
