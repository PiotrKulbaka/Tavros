...
===============
*/
static void Demos_MenuEvent(void* ptr, int32 event)
{
...
=================
*/
static sfxHandle_t UI_DemosMenu_Key(int32 key)
{
    menucommon_s* item;
...
static void Demos_MenuInit()
{
    ...
    Com_sprintf(extension, sizeof(extension), "dm_%d", (int32) Cvar_VariableValue("protocol"));
