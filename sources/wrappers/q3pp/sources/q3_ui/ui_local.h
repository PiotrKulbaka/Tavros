...
extern tavros::math::vec4 menu_text_color;
extern tavros::math::vec4 color_black;
extern tavros::math::vec4 color_white;
extern tavros::math::vec4 color_yellow;
extern tavros::math::vec4 color_orange;
extern tavros::math::vec4 color_red;
extern tavros::math::vec4 listbar_color;
extern tavros::math::vec4 text_color_disabled;
extern tavros::math::vec4 text_color_normal;
extern tavros::math::vec4 text_color_highlight;
...
extern void        MField_Draw(mfield_t* edit, int32 x, int32 y, int32 style, tavros::math::vec4 color);
...
extern void       UI_FillRect(float x, float y, float width, float height, tavros::math::vec4 color);
extern void       UI_DrawRect(float x, float y, float width, float height, tavros::math::vec4 color);
extern void       UI_SetColor(const float* rgba);
extern void       UI_DrawBannerString(int32 x, int32 y, const char* str, int32 style, tavros::math::vec4 color);
extern float      UI_ProportionalSizeScale(int32 style);
extern void       UI_DrawProportionalString(int32 x, int32 y, const char* str, int32 style, tavros::math::vec4 color);
int32             UI_ProportionalStringWidth(const char* str);
extern void       UI_DrawProportionalString_AutoWrapped(int32 x, int32 ystart, int32 xmax, int32 ystep, const char* str, int32 style, tavros::math::vec4 color);
extern void       UI_DrawString(int32 x, int32 y, const char* str, int32 style, tavros::math::vec4 color);
extern void       UI_DrawChar(int32 x, int32 y, int32 ch, int32 style, tavros::math::vec4 color);
