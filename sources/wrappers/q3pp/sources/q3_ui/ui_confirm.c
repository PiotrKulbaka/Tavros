...
=================
*/
static void ConfirmMenu_Event(void* ptr, int32 event)
{
    bool result;
...
=================
*/
static sfxHandle_t ConfirmMenu_Key(int32 key)
{
    switch (key) {
    case K_KP_LEFTARROW:
    case K_LEFTARROW:
...
=================
*/
void UI_ConfirmMenu_Style(const char* question, int32 style, void (*draw)(), void (*action)(bool result))
{
...
=================
*/
void UI_ConfirmMenu(const char* question, void (*draw)(), void (*action)(bool result))
{
