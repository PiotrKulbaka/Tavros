...
static int32 gamecodetoui[] = {4, 2, 3, 0, 5, 1, 6};
static int32 uitogamecode[] = {4, 6, 2, 3, 1, 5, 7};
...
=================
*/
static sfxHandle_t PlayerSettings_MenuKey(int32 key)
{
...
=================
*/
static void PlayerSettings_MenuEvent(void* ptr, int32 event)
{
