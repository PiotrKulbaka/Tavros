...
void MField_Paste(mfield_t* edit)
{
    ...
    if (char* cbd = Sys_GetClipboardData()) {
        Q_strncpyz(pasteBuffer, cbd, 64);
        Z_Free(cbd);
    } else {
        *pasteBuffer = 0;
    }
...
=================
*/
void MField_KeyDownEvent(mfield_t* edit, int32 key)
{
    int32 len;
...
==================
*/
void MField_CharEvent(mfield_t* edit, int32 ch)
{
    int32 len;
...
==================
*/
sfxHandle_t MenuField_Key(menufield_s* m, int32* key)
{
    int32 keycode;
