...
=================
*/
static void UI_AddBotsMenu_FightEvent(void* ptr, int32 event)
{
    const char* team;
    int32       skill;
...
=================
*/
static void UI_AddBotsMenu_BotEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_AddBotsMenu_BackEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_AddBotsMenu_UpEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_AddBotsMenu_DownEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static int32 QDECL UI_AddBotsMenu_SortCompare(const void* arg1, const void* arg2)
{
    int32       num1, num2;
...
static void UI_AddBotsMenu_Init()
{
    ...
    __UI_GetConfigString(CS_SERVERINFO, info, MAX_INFO_STRING);
    ...
    addBotsMenuInfo.skill.curvalue = Com_Clamp(0, 4, (int32) Cvar_VariableValue("g_spSkill") - 1);
