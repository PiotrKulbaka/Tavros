...
=================
*/
static void PlayerModel_MenuEvent(void* ptr, int32 event)
{
...
=================
*/
static sfxHandle_t PlayerModel_MenuKey(int32 key)
{
    menucommon_s* m;
    int32         picnum;
...
=================
*/
static void PlayerModel_PicEvent(void* ptr, int32 event)
{
    int32 modelnum;
    int32 maxlen;
    char* buffptr;
    ...
    if (pdest) {
        ...
        Q_strncpyz((char*) s_playermodel.modelname.string, buffptr, maxlen);
        Q_strupr((char*) s_playermodel.modelname.string);
        ...
        Q_strncpyz((char*) s_playermodel.skinname.string, pdest + 5, maxlen);
        Q_strupr((char*) s_playermodel.skinname.string);
...
static void PlayerModel_SetMenuItems()
{
    ...
    // name
    Cvar_VariableStringBuffer("name", (char*) s_playermodel.playername.string, 16);
    Q_CleanStr((char*) s_playermodel.playername.string);
...
static void PlayerModel_MenuInit()
{
    ...
    for (i = 0, k = 0; i < PLAYERGRID_ROWS; i++) {
        ...
        for (j = 0; j < PLAYERGRID_COLS; j++, k++) {
            ...
            s_playermodel.pics[k].focuscolor = color_red;
            ...
            s_playermodel.picbuttons[k].focuscolor = color_red;
