...
typedef struct
{
    ...
    int32 mapGamebits[MAX_SERVERMAPS];
} startserver_t;
...
static int32 gametype_remap[] = {GT_FFA, GT_TEAM, GT_TOURNAMENT, GT_CTF};
static int32 gametype_remap2[] = {0, 2, 0, 1, 3};
...
=================
*/
static int32 GametypeBits(char* string)
{
    int32 bits;
    char* p;
    char* token;
...
static void StartServer_Update()
{
    ...
    if (!s_startserver.nummaps) {
        ...
        // set the map name
        strcpy((char*) s_startserver.mapname.string, "NO MAPS FOUND");
    } else {
        // set the highlight
        s_startserver.next.generic.flags &= ~QMF_INACTIVE;
        ...
        // set the map name
        strcpy((char*) s_startserver.mapname.string, s_startserver.maplist[s_startserver.currentmap]);
    }

    Q_strupr((char*) s_startserver.mapname.string);
}
...
=================
*/
static void StartServer_MapEvent(void* ptr, int32 event)
{
...
=================
*/
static void StartServer_GametypeEvent(void* ptr, int32 event)
{
    int32       i;
    int32       count;
    int32       gamebits;
...
=================
*/
static void StartServer_MenuEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
static void StartServer_LevelshotDraw(void* self)
{
    ...
    UI_FillRect(x, y, b->width, 28, color_black);
...
=================
*/
static void ServerOptions_Event(void* ptr, int32 event)
{
    switch (((menucommon_s*) ptr)->id) {
...
static void ServerOptions_PlayerNameEvent(void* ptr, int32 event)
{
    int32 n;
...
static void ServerOptions_StatusBar(void* ptr)
{
    switch (((menucommon_s*) ptr)->id) {
    default:
        UI_DrawString(320, 440, "0 = NO LIMIT", UI_CENTER | UI_SMALLFONT, color_white);
        break;
    }
}
...
static void ServerOptions_LevelshotDraw(void* self)
{
    ...
    x = b->generic.x;
    y = b->generic.y + b->height;
    UI_FillRect(x, y, b->width, 40, color_black);
...
static void ServerOptions_SetMenuItems()
{
    ...
    case GT_FFA:
    default:
        Com_sprintf(s_serveroptions.fraglimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_ffa_fraglimit")));
        Com_sprintf(s_serveroptions.timelimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_ffa_timelimit")));
        break;

    case GT_TOURNAMENT:
        Com_sprintf(s_serveroptions.fraglimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_tourney_fraglimit")));
        Com_sprintf(s_serveroptions.timelimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_tourney_timelimit")));
        break;

    case GT_TEAM:
        Com_sprintf(s_serveroptions.fraglimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_team_fraglimit")));
        Com_sprintf(s_serveroptions.timelimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_team_timelimit")));
        s_serveroptions.friendlyfire.curvalue = (int32) Com_Clamp(0, 1, Cvar_VariableValue("ui_team_friendly"));
        break;

    case GT_CTF:
        Com_sprintf(s_serveroptions.flaglimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 100, Cvar_VariableValue("ui_ctf_capturelimit")));
        Com_sprintf(s_serveroptions.timelimit.field.buffer, 4, "%i", (int32) Com_Clamp(0, 999, Cvar_VariableValue("ui_ctf_timelimit")));
        s_serveroptions.friendlyfire.curvalue = (int32) Com_Clamp(0, 1, Cvar_VariableValue("ui_ctf_friendly"));
        break;
    }
...
static void ServerOptions_MenuInit(bool multiplayer)
{
    ...
    s_serveroptions.gametype = (int32) Com_Clamp(0, 5, Cvar_VariableValue("g_gameType"));
...
=================
*/
static int32 QDECL UI_BotSelectMenu_SortCompare(const void* arg1, const void* arg2)
{
    int32       num1, num2;
...
=================
*/
static void ServerPlayerIcon(const char* modelAndSkin, char* iconName, int32 iconNameMaxSize)
{
    char* skin;
...
=================
*/
static void UI_BotSelectMenu_LeftEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_BotSelectMenu_RightEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_BotSelectMenu_BotEvent(void* ptr, int32 event)
{
    int32 i;
...
=================
*/
static void UI_BotSelectMenu_BackEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_BotSelectMenu_SelectEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
