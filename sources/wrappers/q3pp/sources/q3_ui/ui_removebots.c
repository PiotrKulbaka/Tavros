...
typedef struct
{
    ...
    int32 numBots;
    int32 baseBotNum;
    int32 selectedBotNum;
    char  botnames[7][32];
    int32 botClientNums[MAX_BOTS];
...
static void UI_RemoveBotsMenu_SetBotNames()
{
    ...
    for (n = 0; (n < 7) && (removeBotsMenuInfo.baseBotNum + n < removeBotsMenuInfo.numBots); n++) {
        __UI_GetConfigString(CS_PLAYERS + removeBotsMenuInfo.botClientNums[removeBotsMenuInfo.baseBotNum + n], info, MAX_INFO_STRING);
...
=================
*/
static void UI_RemoveBotsMenu_DeleteEvent(void* ptr, int32 event)
{
...
=================
*/
static void UI_RemoveBotsMenu_BotEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_RemoveBotsMenu_BackEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_RemoveBotsMenu_UpEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
=================
*/
static void UI_RemoveBotsMenu_DownEvent(void* ptr, int32 event)
{
    if (event != QM_ACTIVATED) {
        return;
    }
...
static void UI_RemoveBotsMenu_GetBots()
{
    ...
    for (n = 0; n < numPlayers; n++) {
        __UI_GetConfigString(CS_PLAYERS + n, info, MAX_INFO_STRING);
