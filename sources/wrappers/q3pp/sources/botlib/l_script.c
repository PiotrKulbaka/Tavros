...
void PS_CreatePunctuationTable(script_t* script, punctuation_t* punctuations)
{
    ...
    for (i = 0; punctuations[i].p; i++) {
        ...
        for (p = script->punctuationtable[(uint32) newp->p[0]]; p; p = p->next) {
            if (strlen(p->p) < strlen(newp->p)) {
                newp->next = p;
                if (lastp) {
                    lastp->next = newp;
                } else {
                    script->punctuationtable[(uint32) newp->p[0]] = newp;
                }
                break;
            }
            lastp = p;
...
const char* PunctuationFromNum(script_t* script, int32 num)
{
    int32 i;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadWhiteSpace(script_t* script)
{
    if (!script->script_p) {
        return 0;
    }
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadEscapeCharacter(script_t* script, char* ch)
{
    int32 c, val, i;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadString(script_t* script, token_t* token, int32 quote)
{
    int32 len, tmpline;
    char* tmpscript_p;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadName(script_t* script, token_t* token)
{
    int32 len = 0;
    char  c;
...
// Changes Globals:        -
//============================================================================
void NumberValue(char* string, int32 subtype, uint32* intvalue, long double* floatvalue)
{
    uint32 dotfound = 0;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadNumber(script_t* script, token_t* token)
{
    int32 len = 0, i;
    int32 octal, dot;
    char  c;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadPunctuation(script_t* script, token_t* token)
{
    int32          len;
    const char*    p;
    punctuation_t* punc;
...
#ifdef PUNCTABLE
    for (punc = script->punctuationtable[(uint32) *script->script_p]; punc; punc = punc->next) {
#else
    int32 i;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadPrimitive(script_t* script, token_t* token)
{
    int32 len;
...
// Changes Globals:        -
//============================================================================
int32 PS_ReadToken(script_t* script, token_t* token)
{
...
// Changes Globals:        -
//============================================================================
int32 PS_ExpectTokenType(script_t* script, int32 type, int32 subtype, token_t* token)
{
    char str[MAX_TOKEN];
...
// Changes Globals:        -
//============================================================================
void SetScriptFlags(script_t* script, int32 flags)
{
    script->flags = flags;
}
//============================================================================
...
// Changes Globals:        -
//============================================================================
int32 EndOfScript(script_t* script)
{
...
// Changes Globals:        -
//============================================================================
script_t* LoadScriptMemory(char* ptr, int32 length, const char* name)
{
    void*     buffer;
    script_t* script;
