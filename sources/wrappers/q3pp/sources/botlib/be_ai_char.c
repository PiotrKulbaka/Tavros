...
// Changes Globals:        -
//========================================================================
bot_character_t* BotCharacterFromHandle(int32 handle)
{
...
// Changes Globals:        -
//========================================================================
void BotFreeCharacter2(int32 handle)
{
    if (handle <= 0 || handle > MAX_CLIENTS) {
        botimport.Print(PRT_FATAL, "character handle %d out of range\n", handle);
        return;
...
// Changes Globals:        -
//========================================================================
void BotFreeCharacter(int32 handle)
{
...
// Changes Globals:        -
//===========================================================================
bot_character_t* BotLoadCharacterFromFile(const char* charfile, int32 skill)
{
    int32            indent, index, foundcharacter;
    bot_character_t* ch;
    source_t*        source;
    token_t          token;
...
// Changes Globals:        -
//===========================================================================
int32 BotFindCachedCharacter(const char* charfile, float skill)
{
    int32 handle;
...
// Changes Globals:        -
//===========================================================================
int32 BotLoadCachedCharacter(const char* charfile, float skill, int32 reload)
{
    int32            handle, cachedhandle, intskill;
...
// Changes Globals:        -
//===========================================================================
int32 BotLoadCharacterSkill(char* charfile, float skill)
{
    int32 ch, defaultch;
...
// Changes Globals:        -
//===========================================================================
int32 BotInterpolateCharacters(int32 handle1, int32 handle2, float desiredskill)
{
...
{
    int32 firstskill, secondskill, handle;
...
// Changes Globals:        -
//===========================================================================
int32 CheckCharacteristicIndex(int32 character, int32 index)
{
    bot_character_t* ch;
...
int32 Characteristic_Integer(int32 character, int32 index)
{
    ...
    // floats are casted to integers
        ...
        return (int32) ch->c[index].value._float;
    } else {
