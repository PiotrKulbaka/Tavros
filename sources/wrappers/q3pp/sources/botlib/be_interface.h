...
{
    int32 botlibsetup; // true when the bot library has been setup
    int32 maxentities; // maximum number of entities
...
extern int32            bot_developer; // true if developer is on
