...
void AAS_ContinueInit(float time)
{
    ...
    if (aasworld.savefile || ((int32) LibVarGetValue("forcewrite"))) {
        // optimize the AAS data
        if ((int32) LibVarValue("aasoptimize", "0")) {
            AAS_Optimize();
        }
        // save the AAS file
...
int32 AAS_LoadFiles(const char* mapname)
{
    int32 errnum;
...
int32 AAS_Setup()
{
    aasworld.maxclients = (int32) LibVarValue("maxclients", "128");
    aasworld.maxentities = (int32) LibVarValue("maxentities", "1024");
