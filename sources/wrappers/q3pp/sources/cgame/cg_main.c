...
void CG_RegisterCvars()
{
    ...
    cg_ignore = Cvar_Get("cg_ignore", "0", 0);
    ...
    cg_draw2D = Cvar_Get("cg_draw2D", "1", CVAR_ARCHIVE);
    cg_drawStatus = Cvar_Get("cg_drawStatus", "1", CVAR_ARCHIVE);
    cg_drawTimer = Cvar_Get("cg_drawTimer", "1", CVAR_ARCHIVE);
    cg_drawFPS = Cvar_Get("cg_drawFPS", "0", CVAR_ARCHIVE);
    cg_drawSnapshot = Cvar_Get("cg_drawSnapshot", "0", CVAR_ARCHIVE);
    cg_draw3dIcons = Cvar_Get("cg_draw3dIcons", "1", CVAR_ARCHIVE);
    cg_drawIcons = Cvar_Get("cg_drawIcons", "1", CVAR_ARCHIVE);
    cg_drawAmmoWarning = Cvar_Get("cg_drawAmmoWarning", "1", CVAR_ARCHIVE);
    cg_drawAttacker = Cvar_Get("cg_drawAttacker", "1", CVAR_ARCHIVE);
    cg_drawRewards = Cvar_Get("cg_drawRewards", "1", CVAR_ARCHIVE);
    cg_crosshairSize = Cvar_Get("cg_crosshairSize", "24", CVAR_ARCHIVE);
    cg_crosshairHealth = Cvar_Get("cg_crosshairHealth", "1", CVAR_ARCHIVE);
    cg_crosshairX = Cvar_Get("cg_crosshairX", "0", CVAR_ARCHIVE);
    cg_crosshairY = Cvar_Get("cg_crosshairY", "0", CVAR_ARCHIVE);
    cg_brassTime = Cvar_Get("cg_brassTime", "2500", CVAR_ARCHIVE);
    cg_simpleItems = Cvar_Get("cg_simpleItems", "0", CVAR_ARCHIVE);
    cg_lagometer = Cvar_Get("cg_lagometer", "1", CVAR_ARCHIVE);
    cg_railTrailTime = Cvar_Get("cg_railTrailTime", "400", CVAR_ARCHIVE);
    cg_gun_x = Cvar_Get("cg_gunX", "0", CVAR_CHEAT);
    cg_gun_y = Cvar_Get("cg_gunY", "0", CVAR_CHEAT);
    cg_gun_z = Cvar_Get("cg_gunZ", "0", CVAR_CHEAT);
    cg_centertime = Cvar_Get("cg_centertime", "3", CVAR_CHEAT);
    cg_runpitch = Cvar_Get("cg_runpitch", "0.002", CVAR_ARCHIVE);
    cg_runroll = Cvar_Get("cg_runroll", "0.005", CVAR_ARCHIVE);
    cg_bobup = Cvar_Get("cg_bobup", "0.005", CVAR_CHEAT);
    cg_bobpitch = Cvar_Get("cg_bobpitch", "0.002", CVAR_ARCHIVE);
    cg_bobroll = Cvar_Get("cg_bobroll", "0.002", CVAR_ARCHIVE);
    cg_swingSpeed = Cvar_Get("cg_swingSpeed", "0.3", CVAR_CHEAT);
    cg_animSpeed = Cvar_Get("cg_animspeed", "1", CVAR_CHEAT);
    cg_debugAnim = Cvar_Get("cg_debuganim", "0", CVAR_CHEAT);
    cg_debugPosition = Cvar_Get("cg_debugposition", "0", CVAR_CHEAT);
    ...
    cg_noPlayerAnims = Cvar_Get("cg_noplayeranims", "0", CVAR_CHEAT);
    cg_showmiss = Cvar_Get("cg_showmiss", "0", 0);
    cg_footsteps = Cvar_Get("cg_footsteps", "1", CVAR_CHEAT);
    cg_tracerChance = Cvar_Get("cg_tracerchance", "0.4", CVAR_CHEAT);
    cg_tracerWidth = Cvar_Get("cg_tracerwidth", "1", CVAR_CHEAT);
    cg_tracerLength = Cvar_Get("cg_tracerlength", "100", CVAR_CHEAT);
