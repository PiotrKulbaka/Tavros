...
static tavros::core::logger logger("cg_playerstate");
...
==============
*/
void CG_DamageFeedback(int32 yawByte, int32 pitchByte, int32 damage)
{
    float  left, front, up;
    float  kick;
    int32  health;
...
==================
*/
static void pushReward(sfxHandle_t sfx, qhandle_t shader, int32 rewardCount)
{
...
{
    int32       highScore, health, armor, reward;
    sfxHandle_t sfx;
    ...
    if (ps->persistant[PERS_IMPRESSIVE_COUNT] != ops->persistant[PERS_IMPRESSIVE_COUNT]) {
        ...
        reward = true;
        logger.debug("impressive");
    }
    if (ps->persistant[PERS_EXCELLENT_COUNT] != ops->persistant[PERS_EXCELLENT_COUNT]) {
        sfx = cgs.media.excellentSound;
        pushReward(sfx, cgs.media.medalExcellent, ps->persistant[PERS_EXCELLENT_COUNT]);
        reward = true;
        logger.debug("excellent");
    }
    if (ps->persistant[PERS_GAUNTLET_FRAG_COUNT] != ops->persistant[PERS_GAUNTLET_FRAG_COUNT]) {
        sfx = cgs.media.humiliationSound;
        pushReward(sfx, cgs.media.medalGauntlet, ps->persistant[PERS_GAUNTLET_FRAG_COUNT]);
        reward = true;
        logger.debug("guantlet frag");
    }
