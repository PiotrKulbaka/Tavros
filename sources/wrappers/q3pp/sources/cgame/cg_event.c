...
static tavros::core::logger logger("cg_event");
...
================
*/
static void CG_ItemPickup(int32 itemNum)
{
...
void CG_EntityEvent(centity_t* cent, vec3_t position)
{
    ...
    if (cg_debugEvents->integer) {
        logger.info("ent:%3i  event:%3i ", es->number, event);
    }
    ...
    case EV_DEATH3:
        DEBUGNAME("EV_DEATHx");
        S_StartSound(NULL, es->number, CHAN_VOICE, CG_CustomSound(es->number, va("*death%i.wav", event - EV_DEATH1 + 1)));
        break;
