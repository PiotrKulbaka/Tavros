...
void CG_RegisterWeapon(int32 weaponNum)
{
    ...
    case WP_GAUNTLET:
        ...
        weaponInfo->firingSound = S_RegisterSound("sound/weapons/melee/fstrun.wav", false);
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/melee/fstatck.wav", false);
        break;

    case WP_LIGHTNING:
        MAKERGB(weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f);
        weaponInfo->readySound = S_RegisterSound("sound/weapons/melee/fsthum.wav", false);
        weaponInfo->firingSound = S_RegisterSound("sound/weapons/lightning/lg_hum.wav", false);

        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/lightning/lg_fire.wav", false);
        ...
        cgs.media.sfx_lghit1 = S_RegisterSound("sound/weapons/lightning/lg_hit.wav", false);
        cgs.media.sfx_lghit2 = S_RegisterSound("sound/weapons/lightning/lg_hit2.wav", false);
        cgs.media.sfx_lghit3 = S_RegisterSound("sound/weapons/lightning/lg_hit3.wav", false);
    ...
    case WP_MACHINEGUN:
        ...
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/machinegun/machgf1b.wav", false);
        weaponInfo->flashSound[1] = S_RegisterSound("sound/weapons/machinegun/machgf2b.wav", false);
        weaponInfo->flashSound[2] = S_RegisterSound("sound/weapons/machinegun/machgf3b.wav", false);
        weaponInfo->flashSound[3] = S_RegisterSound("sound/weapons/machinegun/machgf4b.wav", false);
    ...
    case WP_SHOTGUN:
        MAKERGB(weaponInfo->flashDlightColor, 1, 1, 0);
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/shotgun/sshotf1b.wav", false);
    ...
    case WP_GRENADE_LAUNCHER:
        ...
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/grenade/grenlf1a.wav", false);
    ...
    case WP_PLASMAGUN:
        ...
        weaponInfo->missileSound = S_RegisterSound("sound/weapons/plasma/lasfly.wav", false);
        MAKERGB(weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f);
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/plasma/hyprbf1a.wav", false);
        cgs.media.plasmaExplosionShader = RE_RegisterShader("plasmaExplosion");
        cgs.media.railRingsShader = RE_RegisterShader("railDisc");
        break;

    case WP_RAILGUN:
        weaponInfo->readySound = S_RegisterSound("sound/weapons/railgun/rg_hum.wav", false);
        MAKERGB(weaponInfo->flashDlightColor, 1, 0.5f, 0);
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/railgun/railgf1a.wav", false);
    ...
    case WP_BFG:
        weaponInfo->readySound = S_RegisterSound("sound/weapons/bfg/bfg_hum.wav", false);
        MAKERGB(weaponInfo->flashDlightColor, 1, 0.7f, 1);
        weaponInfo->flashSound[0] = S_RegisterSound("sound/weapons/bfg/bfg_fire.wav", false);
...
=================
*/
static int32 CG_MapTorsoToWeaponFrame(clientInfo_t* ci, int32 frame)
{
    // change weapon
...
========================
*/
static void CG_AddWeaponWithPowerups(refEntity_t* gun, int32 powerups)
{
    // add powerup effects
...
===============
*/
static bool CG_WeaponSelectable(int32 i)
{
    if (!cg.snap->ps.ammo[i]) {
        return false;
    }
...
================
*/
static void CG_ShotgunPellet(vec3_t start, vec3_t end, int32 skipNum)
{
    trace_t tr;
    int32   sourceContentType, destContentType;
...
================
*/
static void CG_ShotgunPattern(vec3_t origin, vec3_t origin2, int32 seed, int32 otherEntNum)
{
    int32  i;
    float  r, u;
    vec3_t end;
...
======================
*/
static bool CG_CalcMuzzlePoint(int32 entityNum, vec3_t muzzle)
{
    vec3_t     forward;
    centity_t* cent;
    int32      anim;
...
======================
*/
void CG_Bullet(vec3_t end, int32 sourceEntityNum, vec3_t normal, bool flesh, int32 fleshEntityNum)
{
    trace_t trace;
    int32   sourceContentType, destContentType;
    vec3_t  start;
