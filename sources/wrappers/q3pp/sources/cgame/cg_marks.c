...
void CG_ImpactMark(qhandle_t markShader, const vec3_t origin, const vec3_t dir, float orientation, float red, float green, float blue, float alpha, bool alphaFade, float radius, bool temporary)
{
    ...
    for (i = 0, mf = markFragments; i < numFragments; i++, mf++) {
        ...
        for (j = 0, v = verts; j < mf->numPoints; j++, v++) {
            ...
            *(int32*) v->modulateU8 = *(int32*) colors;
        }
    ...
    for (; mp != &cg_activeMarkPolys; mp = next) {
        ...
        if (mp->markShader == cgs.media.energyMarkShader) {
            ...
            if (fade < 255) {
                ...
                if (mp->verts[0].modulateU8[0] != 0) {
                    for (j = 0; j < mp->poly.numVerts; j++) {
                        mp->verts[j].modulateU8[0] = mp->color[0] * fade;
                        mp->verts[j].modulateU8[1] = mp->color[1] * fade;
                        mp->verts[j].modulateU8[2] = mp->color[2] * fade;
                    }
                }
            }
        }
...
static int32     shaderAnimCounts[MAX_SHADER_ANIMS] = {
    23
};
static float shaderAnimSTRatio[MAX_SHADER_ANIMS] = {
    1.0f
};
static int32 numShaderAnims;
// done.
...
int32        cl_numparticles = MAX_PARTICLES;
...
void CG_ClearParticles()
{
    ...
    for (i = 0; shaderAnimNames[i]; i++) {
        ...
        for (j = 0; j < shaderAnimCounts[i]; j++) {
            const char* s = va("%s%i", shaderAnimNames[i], j + 1);
            shaderAnims[i][j] = RE_RegisterShader(s);
        }
    }
    numShaderAnims = i;
    // done.
...
void CG_AddParticleToScene(cparticle_t* p, vec3_t org, float alpha)
{
    ...
    if (p->type == P_WEATHER || p->type == P_WEATHER_TURBULENT || p->type == P_WEATHER_FLURRY
        ...
        if (p->type == P_BUBBLE || p->type == P_BUBBLE_TURBULENT) {
            ...
            verts[0].modulateU8[3] = 255 * p->alpha;
            ...
            verts[1].modulateU8[3] = 255 * p->alpha;
            ...
            verts[2].modulateU8[3] = 255 * p->alpha;
            ...
            verts[3].modulateU8[3] = 255 * p->alpha;
        } else {
            VectorMA(org, -p->height, pvup, point);
            VectorMA(point, -p->width, pvright, point);
            ...
            TRIverts[0].st[0] = 1;
            TRIverts[0].st[1] = 0;
            TRIverts[0].modulateU8[0] = 255;
            TRIverts[0].modulateU8[1] = 255;
            TRIverts[0].modulateU8[2] = 255;
            TRIverts[0].modulateU8[3] = 255 * p->alpha;
            ...
            TRIverts[1].st[0] = 0;
            TRIverts[1].st[1] = 0;
            TRIverts[1].modulateU8[0] = 255;
            TRIverts[1].modulateU8[1] = 255;
            TRIverts[1].modulateU8[2] = 255;
            TRIverts[1].modulateU8[3] = 255 * p->alpha;
            ...
            TRIverts[2].st[0] = 0;
            TRIverts[2].st[1] = 1;
            TRIverts[2].modulateU8[0] = 255;
            TRIverts[2].modulateU8[1] = 255;
            TRIverts[2].modulateU8[2] = 255;
            TRIverts[2].modulateU8[3] = 255 * p->alpha;
        }
        ...
        verts[0].st[0] = 0;
        verts[0].st[1] = 0;
        verts[0].modulateU8[0] = 255 * color[0];
        verts[0].modulateU8[1] = 255 * color[1];
        verts[0].modulateU8[2] = 255 * color[2];
        verts[0].modulateU8[3] = 255 * invratio;
        ...
        verts[1].st[0] = 0;
        verts[1].st[1] = 1;
        verts[1].modulateU8[0] = 255 * color[0];
        verts[1].modulateU8[1] = 255 * color[1];
        verts[1].modulateU8[2] = 255 * color[2];
        verts[1].modulateU8[3] = 255 * invratio;
        ...
        verts[2].st[0] = 1;
        verts[2].st[1] = 1;
        verts[2].modulateU8[0] = 255 * color[0];
        verts[2].modulateU8[1] = 255 * color[1];
        verts[2].modulateU8[2] = 255 * color[2];
        verts[2].modulateU8[3] = 255 * invratio;
        ...
        verts[3].st[0] = 1;
        verts[3].st[1] = 0;
        verts[3].modulateU8[0] = 255 * color[0];
        verts[3].modulateU8[1] = 255 * color[1];
        verts[3].modulateU8[2] = 255 * color[2];
        verts[3].modulateU8[3] = 255 * invratio;
        ...
        verts[0].st[0] = 0;
        verts[0].st[1] = 0;
        verts[0].modulateU8[0] = 111;
        verts[0].modulateU8[1] = 19;
        verts[0].modulateU8[2] = 9;
        verts[0].modulateU8[3] = 255 * alpha;
        ...
        verts[1].st[0] = 0;
        verts[1].st[1] = 1;
        verts[1].modulateU8[0] = 111;
        verts[1].modulateU8[1] = 19;
        verts[1].modulateU8[2] = 9;
        verts[1].modulateU8[3] = 255 * alpha;
        ...
        verts[2].st[0] = 1;
        verts[2].st[1] = 1;
        verts[2].modulateU8[0] = 111;
        verts[2].modulateU8[1] = 19;
        verts[2].modulateU8[2] = 9;
        verts[2].modulateU8[3] = 255 * alpha;
        ...
        verts[3].st[0] = 1;
        verts[3].st[1] = 0;
        verts[3].modulateU8[0] = 111;
        verts[3].modulateU8[1] = 19;
        verts[3].modulateU8[2] = 9;
        verts[3].modulateU8[3] = 255 * alpha;
    ...
    // Ridah
        ...
        i = p->shaderAnim;
        j = (int32) floor(ratio * shaderAnimCounts[p->shaderAnim]);
