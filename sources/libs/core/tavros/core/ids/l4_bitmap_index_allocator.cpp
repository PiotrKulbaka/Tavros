...
namespace tavros::core
{
    ...
    index_type l4_bitmap_index_allocator::allocate() noexcept
    {
            ...
            if (l2_word != UINT64_MAX) {
                ...
                if (l3_word != UINT64_MAX) {
                    ...
                    if (l4_word != UINT64_MAX) {
                        ...
                        const uint64 l4_word_now = m_l4_map[l4_base_index];
                        if (l4_word_now == UINT64_MAX) {
                            // Update l3 map
    ...
    void l4_bitmap_index_allocator::deallocate(index_type index) noexcept
    {
        TAV_ASSERT(index < k_max_index);
    ...
    bool l4_bitmap_index_allocator::try_deallocate(index_type index) noexcept
    {
    ...
    size_t l4_bitmap_index_allocator::max_index() const noexcept
    {
        return k_max_index;
    }

    size_t l4_bitmap_index_allocator::remaining() const noexcept
    {
        return m_remaining;
    }
