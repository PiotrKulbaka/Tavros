...
namespace tavros::core
{
    ...
    index_allocator_base::index_t l3_index_allocator::allocate() noexcept
    {
    ...
    void l3_index_allocator::deallocate(index_t index) noexcept
    {
        TAV_ASSERT(index < k_total_indices);
        ...
        TAV_ASSERT(0 != (l3_word & (1ull << l3_bit_idx)));
    ...
    void l3_index_allocator::reset() noexcept
    {
    ...
    size_t l3_index_allocator::capacity() const noexcept
    {
        return k_total_indices;
    }

    size_t l3_index_allocator::remaining() const noexcept
    {
