...
namespace tavros::core
{
    ...
    /**
     * @class l3_bitmap_index_allocator
     ...
     * - The total class size 33408 bytes (~32.7 KB).
     *
     * @note All indices are 0-based.
     * @note Capacity is fixed and determined by k_max_index.
     */
    class l3_bitmap_index_allocator final : public index_allocator
    {
    private:
    ...
    public:
        constexpr static index_t k_max_index = static_cast<index_t>(k_l3_map_size * k_bits_per_word);

    public:
        l3_bitmap_index_allocator() noexcept;

        ~l3_bitmap_index_allocator() noexcept override = default;
