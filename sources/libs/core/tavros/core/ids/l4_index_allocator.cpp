...
namespace tavros::core
{
    ...
    void l4_index_allocator::deallocate(uint32 index) noexcept
    {
        ...
        TAV_ASSERT(0 != (l4_word & (1ull << l4_bit_idx)));
    ...
    void l4_index_allocator::reset() noexcept
    {
    ...
    size_t l4_index_allocator::capacity() const noexcept
    {
        return k_total_indices;
    }

    size_t l4_index_allocator::remaining() const noexcept
    {
