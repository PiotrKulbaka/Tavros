...
namespace tavros::input
{
    ...
    public:
         ...
         */
        bool is_key_held(keyboard_key key) const noexcept;
         ...
         */
        bool is_mouse_button_just_pressed(mouse_button button) const noexcept;

        /**
         * @brief Returns true if the specified button is in the current frame released.
         */
        bool is_mouse_button_just_released(mouse_button button) const noexcept;

        /**
         * @brief Returns true if the specified button is in the pressed state during this frame.
         */
        bool is_mouse_button_held(mouse_button button) const noexcept;
         ...
         */
        math::isize2 window_size() const noexcept;
         ...
         */
        math::vec2 window_pos() const noexcept;
    ...
    private:
        ...
        static constexpr size_t k_mouse_button_count = static_cast<size_t>(mouse_button::last_button);

        using keyboard_state = std::array<key_state, k_keyboard_size>;
        using mouse_buttons_state = std::array<key_state, k_mouse_button_count>;
    ...
    private:
        ...
        bool       m_is_wheel_scrolled = false;

        bool         m_is_window_resized = false;
        bool         m_is_window_moved = false;
        math::isize2 m_window_size;
        math::vec2   m_window_pos;
    };
