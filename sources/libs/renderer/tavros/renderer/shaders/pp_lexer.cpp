...
namespace tavros::renderer
{
    ...
    pp_token pp_lexer::scan_string_literal() noexcept
    {
        ...
        core::string_view err_msg = quote_char == '"' ? "Unterminated string literal" : "Unterminated character literal";
    ...
    pp_token pp_lexer::scan_directive() noexcept
    {
        ...
        constexpr core::string_view dir_include_name = "include";
        ...
        core::string_view sv{dir_beg, m_forward};
