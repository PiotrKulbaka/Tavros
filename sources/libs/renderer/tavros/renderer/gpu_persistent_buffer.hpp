...
namespace tavros::renderer
{
    ...
    public:
        ...
        {
            const size_t align = alignof(T) > 256 ? alignof(T) : 256;
            const size_t offset = tavros::math::align_up(m_cursor, align); // TODO: fixit. tavros::math::align_up(m_cursor + m_data.begin(), alignof(T))
