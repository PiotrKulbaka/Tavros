...
namespace
{
    ...
    material_name = {
        ...
        stencil = {                         # "off" or {test = BOOL front = STRING|OBJECT back = STRING|OBJECT}
            test = true                     # true false
