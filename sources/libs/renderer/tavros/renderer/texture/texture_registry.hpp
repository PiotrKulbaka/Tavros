...
namespace tavros::renderer
{
    ...
    /// @brief Opaque handle to a texture managed by texture_registry.
     ...
     */
    class texture_registry : public core::resource_registry<gpu_texture_view, texture_tag, texture_registry>
    {
    public:
        /**
    ...
    public:
         ...
         * @param rrm Render resource manager. Must not be null.
         */
        explicit texture_registry(resource_manager* rrm) noexcept;

        /** @brief Default destructor. */
        ~texture_registry() noexcept = default;
    ...
    public:
        void release_resource(gpu_texture_view& tex_view) noexcept;
