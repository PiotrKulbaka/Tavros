...
function(tavros_add_library)
    set(LIB_NAME "")
    set(LIB_TYPE "STATIC")
    set(LIB_CROSSPLATFORM_SOURCES "")
    set(LIB_MACOS_SOURCES "")
    ...
    foreach(arg IN LISTS ARGN)
        ...
        elseif(arg STREQUAL "LIB_CROSSPLATFORM_SOURCES")
            set(current_section "LIB_CROSSPLATFORM_SOURCES")
        elseif(arg STREQUAL "LIB_MACOS_SOURCES")
            set(current_section "LIB_MACOS_SOURCES")
        elseif(arg STREQUAL "LIB_WIN32_SOURCES")
            set(current_section "LIB_WIN32_SOURCES")
        ...
        elseif(arg STREQUAL "INTERFACE")
            ...
            elseif(current_section STREQUAL "LIB_TYPE")
                set(LIB_TYPE "${arg}")
            elseif(current_section STREQUAL "LIB_CROSSPLATFORM_SOURCES")
                list(APPEND LIB_CROSSPLATFORM_SOURCES "${arg}")
            elseif(current_section STREQUAL "LIB_MACOS_SOURCES")
                list(APPEND LIB_MACOS_SOURCES "${arg}")
            elseif(current_section STREQUAL "LIB_WIN32_SOURCES")
                list(APPEND LIB_WIN32_SOURCES "${arg}")
    ...
    if(LIB_CROSSPLATFORM_SOURCES STREQUAL "")
        message(FATAL_ERROR "No source files specified for ${LIB_NAME}")
    endif()

    add_library(${LIB_NAME} ${LIB_TYPE} ${LIB_CROSSPLATFORM_SOURCES})
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
        ...
        if(NOT LIB_MACOS_SOURCES STREQUAL "")
            target_sources(${LIB_NAME} PRIVATE ${LIB_MACOS_SOURCES})
        endif()
    elseif(CMAKE_SYSTEM_NAME STREQUAL "Windows")
        if(NOT LIB_WIN32_SOURCES STREQUAL "")
            target_sources(${LIB_NAME} PRIVATE ${LIB_WIN32_SOURCES})
        endif()
    endif()
