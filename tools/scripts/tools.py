...
def autoformat(cfg: Config):
    ...
    """
    exts = cfg.command.format.for_exts
    clang_foramt_tool_path = cfg.command.format.clang_format_tool_path
    style_param = f"--style=file:{str(cfg.command.format.style_file)}"

    files = []
    for p in cfg.command.format.paths:
