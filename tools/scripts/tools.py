...
def collect_sources(cfg: Config):
    ...
    def collect_lib_sources(lib_dir, lib_name):
        ...
        platform_macos_sources = [s for s in all_sources if platform_subfolder_macos in str(s)]

        platform_subfolder_win32 = cfg.command.collect_sources.platform_subfolder_win32
        platform_win32_sources = [s for s in all_sources if platform_subfolder_win32 in str(s)]
